...
body. Kinesthetic stimulation is sensed by mechanoreceptors located in the muscles. The kinesthetic mechanoreceptors include muscle spindles in parallel with muscle fibers and Golgi tendon organs in series with them at the connection with the skeleton \cite{rahul15}. In some mainly kinesthetic tasks, the tactile sense only indicates a contact.
...
Friction, hardness, macroscopic roughness, microscopic roughness and thermal conductivity are the main dimensions to build haptic texture models.

\begin{figure}[h!]
	\begin{center}
		\includegraphics[width=15cm]{texture}
