...
\begin{figure} [htbp]
	\begin{center}
		\subfigure[First generated signal from recorded data during interaction with oak at speed 40 mm/s reproduced from given frequencies below.]{\includegraphics[width=0.80\textwidth]{coak1}} 
		\subfigure[An interpolation result between signals in (a) and (d).]{\includegraphics[width=0.80\textwidth]{coak5}} 
...
\begin{figure} [htbp]
	\begin{center}
		...
		\subfigure[Another result of the interpolation. The interpolated amplitudes of the frequencies can be seen in the spectral domain plot below.]{\includegraphics[width=0.80\textwidth]{coak7}} 
		\subfigure[The reproduced signal from recorded data at speed 400 mm/s reproduced from given frequencies below.]{\includegraphics[width=0.80\textwidth]{coak10}} 
...
\begin{figure} [htbp]
	\begin{center}
		\subfigure[$\mu=0$]{\includegraphics[width=0.49\textwidth]{hist1}} 
		\subfigure[$\mu=0.2$]{\includegraphics[width=0.49\textwidth]{hist2}} 
		\subfigure[$\mu=0.4$]{\includegraphics[width=0.49\textwidth]{hist3}} \subfigure[$\mu=0.6$]{\includegraphics[width=0.49\textwidth]{hist4}} 		 
		\label{fig:friction}
	\end{center}
\end{figure} 
...
\begin{figure} [htbp]
	\begin{center}
		...
		\subfigure[$\mu=0.8$]{\includegraphics[width=0.49\textwidth]{hist5}} 
		\subfigure[$\mu=1.0$]{\includegraphics[width=0.49\textwidth]{hist6}} 
		\subfigure[$\mu=1.2$]{\includegraphics[width=0.49\textwidth]{hist7}} 
		\caption{Histograms of each 7 friction coefficients with 240 speed samples saved every 0.2 seconds during virtual surface interaction through a haptic device. The bin width is selected as 4 in each plot.}  
		\label{fig:friction1}
	\end{center}
\end{figure} 
...
\begin{figure} [htbp]
	\begin{center}
		...
		\caption{The number of subjects who gave the answer ``same'' about two compared acceleration signals at the mean speed of the materials displayed via voice coil actuator is given above. Blue bars represent the comparison with \emph{ifft} transformed signals, where yellow bars are for lpc-synthesized signals.} 
		\label{fig:deney1}
	\end{center}
\end{figure} 
