...
\begin{figure} [htbp]
	\begin{center}
		...
		\subfigure[Another result of the interpolation. Combination of the frequencies can be seen in the spectral domain plot below.]{\includegraphics[width=0.80\textwidth]{coak7}} 
		\subfigure[The reproduced signal from recorded data at speed 400mm/s reproduced from given frequencies below.]{\includegraphics[width=0.80\textwidth]{coak10}} 
